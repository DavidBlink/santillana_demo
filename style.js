	...
	santillana_demoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'paso naranja', element: 'h3', attributes: { 'class': 'bck-title32'} },
				{ name: 'paso morado', element: 'h3', attributes: { 'class': 'bck-title33'} },
				{ name: 'paso verde', element: 'h3', attributes: { 'class': 'bck-title34'} },
				{ name: 'paso azul', element: 'h3', attributes: { 'class': 'bck-title35'} },
